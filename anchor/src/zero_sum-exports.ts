...
export function getZeroSumProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...ZeroSumIDL, address: address ? address.toBase58() : ZeroSumIDL.address } as ZeroSum, provider)
}
